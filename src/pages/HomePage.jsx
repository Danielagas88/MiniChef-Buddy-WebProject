export default function HomePage() {
  return (
    <section className="space-y-4">
      ...
      {/* PANTRY HELPER – אפשר לפתח לוגיקה בהמשך */}
      <div className="bg-white bg-opacity-80 rounded-3xl shadow p-4 md:p-6 space-y-3">
        ...
        <p className="text-gray-600 mb-2">
          Enter ingredients you have at home and use them to choose a recipe.
        </p>
        <div className="flex flex-wrap gap-2">
          <input
            type="text"
            placeholder="e.g. eggs, milk, banana..."
            className="flex-1 min-w-[140px] px-3 py-1.5 border border-gray-300 rounded-full text-xs md:text-sm"
          />
          <button className="px-3 py-1.5 text-xs md:text-sm bg-yellow-400 rounded-full hover:bg-yellow-500">
            Add item
          </button>
          <button className="px-3 py-1.5 text-xs md:text-sm bg-purple-400 text-white rounded-full hover:bg-purple-500">
            Scan pantry
          </button>
        </div>
      </div>
